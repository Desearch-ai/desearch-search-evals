...
_DECLINE_PHRASES = (
    "has not yet occurred", "has not yet been determined",
    "has not yet happened", "has not yet been held",
    "is in the future", "is a future event", "event is in the future",
    "is a future date", "yet to occur",
    "not publicly available", "not public information",
    "is mythological", "are mythological", "considered a myth",
    "considered mythological", "is fictional", "are fictional",
    "no historical record", "no recorded",
    "is undefined", "in standard arithmetic", "in standard mathematics",
    "did not write about", "did not exist", "do not exist",
    "had no opinion", "no records of", "no record of",
    "no sources indicating", "no sources indicate",
    "not explicitly documented", "is not documented",
    "no information available", "did not have any",
    "is not specified", "not explicitly provided",
    "not available from", "not available in",
    "the event has not", "is not known", "are not known",
    "not explicitly mentioned", "is not known publicly",
